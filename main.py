...
def solar():
    planets = [
        ...
        Planet(type='EARTH', mass=0.000001, position=[0, 45, 0.0], velocity=[-0.2, 0.0, 0.0], image=image_earth, radius=5, trace_color=(0, 80, 190)),
        Planet(type='EARTH', mass=0.000001, position=[0, 60, 0.0], velocity=[-0.15, 0.0, 0.0], image=image_mars, radius=5, trace_color=(70, 100, 210)),
        Planet(type='EARTH', mass=0.000001, position=[5, 80, 0.0], velocity=[-0.2, 0.0, 0.0], image=image_jupiter, radius=8, trace_color=(0, 100, 210)),
        ...
        Planet(type='EARTH', mass=0.000001, position=[-10, 105, 0.0], velocity=[-0.15, 0.0, 0.0], image=image_uranus, radius=6, trace_color=(10, 100, 110)),
